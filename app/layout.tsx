        ...
        <Toaster 
          ...
          toastOptions={{
            ...
            classNames: {
              ...
              actionButton: "bg-blue-500 hover:bg-blue-600 text-white text-xs px-3 py-1.5 rounded-lg font-medium transition-[background-color,box-shadow] duration-200",
              cancelButton: "bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs px-3 py-1.5 rounded-lg font-medium transition-[background-color,box-shadow] duration-200",
              closeButton: "bg-slate-100 hover:bg-slate-200 text-slate-500 rounded-full p-1 transition-[background-color,color,transform] duration-200 border-0 hover:scale-110",
